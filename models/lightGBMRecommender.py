...
class lightGBMRecommender:
    def __init__(self):
        self.model = lgb.LGBMClassifier(learning_rate=0.005,max_depth=20,random_state=42)
    ...
    def fit(self):
        ...
        self.model.fit(X_train,y_train,eval_set=[(X_test,y_test),(X_train,y_train)],
    ...
    def predict(self, userDogs):
        ...
        y_predict_proba = self.model.predict_proba(dfEncoded.drop(['userid', 'perroid'], axis=1))
