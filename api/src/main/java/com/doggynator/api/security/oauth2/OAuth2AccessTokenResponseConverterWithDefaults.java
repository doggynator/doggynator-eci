...
public class OAuth2AccessTokenResponseConverterWithDefaults
  ...
  public OAuth2AccessTokenResponse convert(final Map<String, Object> tokenResponseParameters) {
    ...
    if (tokenResponseParameters.containsKey(OAuth2ParameterNames.EXPIRES_IN)) {
      try {
        ...
        log.warn("Unable to determine expiration", ex);
      }
    }
    ...
    if (tokenResponseParameters.containsKey(OAuth2ParameterNames.SCOPE)) {
      ...
      scopes =
          Arrays.stream(StringUtils.delimitedListToStringArray(scope.toString(), " "))
  ...
  public final void setDefaultAccessTokenType(
      final OAuth2AccessToken.TokenType defaultAccessTokenType) {
